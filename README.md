...
Когда тебя касаются в VRChat — жилет bHaptics вибрирует. Приложение передаёт касания с аватара на TactSuit и подстраивает силу под тип касания (удар или плавное).
